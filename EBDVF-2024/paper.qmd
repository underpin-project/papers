...
describe components with a similar role: the Federated Catalogue and Broker Service.
...
[PoolParty Semantic Suite](PoolParty Semantic Suite) is a semantic middleware platform based on W3C Semantic Web standards 
