...
our main focus to develop our solution is the [UNDERPIN](https://underpinproject.eu/) project with use cases of refineries and wind farms,
but also other project, like [DataBri-X](https://databri-x.eu/) provide use cases which were considered.
...
Predicting potential failures and optimizing the maintenance operations to minimize the costs can be business critical.
For establishing predictive maintenance, we need high amounts of high qualitative training data,
which can be achieved by consolidation different wind farm measurement sources.
...
- The Data Consumer benefits from:
  - More powerful dataset discovery by using richer semantic queries, eg
